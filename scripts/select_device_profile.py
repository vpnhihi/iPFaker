...
def build_profile(device: dict, ios_ver: str, ios_meta: dict, name: str | None) -> dict:
    ...
    flat = {
        ...
        # MG keys Zalo reads as marketing (Artwork hash / MarketingNameString)
        "MarketingNameString": device["MarketingName"],
        "ArtworkDeviceProductDescription": device["MarketingName"],
        "DeviceName": "iPhone",
        ...
        # Locale / TZ (Zalo env surface — match ProfileBuilder defaults for VN lab)
        "PreferredLanguage": "vi-VN",
        "LocaleIdentifier": "vi_VN",
        "AppleLocale": "vi_VN",
        "AppleLanguages": ["vi-VN"],
        "LanguageCode": "vi",
        "CountryCode": "VN",
        "CurrencyCode": "VND",
